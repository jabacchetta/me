...
const About = ({ toggleView }) => ([
  ...
  <Text key="text" content>
    ...
    sports fan, coffee aficionado, blockchain investor, video game addict, Game of Thrones
    enthusiast, fantasy football champ, aspiring wordsmith, would-be philosopher.
  </Text>,
